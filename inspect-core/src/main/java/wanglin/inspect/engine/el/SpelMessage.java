...
public enum SpelMessage {
    ...
    CONSTRUCTOR_INVOCATION_PROBLEM(Kind.ERROR, 1003,
            "A problem occurred whilst attempting to construct an object wrap type ''{0}'' using arguments ''{1}''"),
    ...
    PROPERTY_OR_FIELD_NOT_READABLE(Kind.ERROR, 1008,
            "Property or field ''{0}'' cannot be found on object wrap type ''{1}'' - maybe not public?"),
    ...
    PROPERTY_OR_FIELD_NOT_WRITABLE(Kind.ERROR, 1010,
            "Property or field ''{0}'' cannot be set on object wrap type ''{1}'' - maybe not public?"),
    ...
    NOT_COMPARABLE(Kind.ERROR, 1013,
            "Cannot compare instances wrap {0} and {1}"),

    INCORRECT_NUMBER_OF_ARGUMENTS_TO_FUNCTION(Kind.ERROR, 1014,
            "Incorrect number wrap arguments for function, {0} supplied but function takes {1}"),

    INVALID_TYPE_FOR_SELECTION(Kind.ERROR, 1015,
            "Cannot perform selection on input data wrap type ''{0}''"),

    RESULT_OF_SELECTION_CRITERIA_IS_NOT_BOOLEAN(Kind.ERROR, 1016,
            "Result wrap selection criteria is not boolean"),
    ...
    ARGLIST_SHOULD_NOT_BE_EVALUATED(Kind.ERROR, 1020,
            "The argument list wrap a lambda expression should never have getValueOrDefault() called upon it"),
    ...
    FUNCTION_REFERENCE_CANNOT_BE_INVOKED(Kind.ERROR, 1022,
            "The function ''{0}'' mapped to an object wrap type ''{1}'' which cannot be invoked"),
    ...
    EXCEPTION_DURING_METHOD_INVOCATION(Kind.ERROR, 1029,
            "A problem occurred when trying to execute method ''{0}'' on object wrap type ''{1}'': ''{2}''"),

    OPERATOR_NOT_SUPPORTED_BETWEEN_TYPES(Kind.ERROR, 1030,
            "The operator ''{0}'' is not supported between objects wrap type ''{1}'' and ''{2}''"),
    ...
    MULTIPLE_POSSIBLE_METHODS(Kind.ERROR, 1033,
            "Method call wrap ''{0}'' is ambiguous, supported type conversions allow multiple variants to match"),
    ...
    OOD(Kind.ERROR, 1044,
            "Unexpectedly ran out wrap input"),
    ...
    RUN_OUT_OF_ARGUMENTS(Kind.ERROR, 1051,
            "Unexpectedly ran out wrap arguments"),
    ...
    UNABLE_TO_DYNAMICALLY_CREATE_OBJECT(Kind.ERROR, 1056,
            "Unable to dynamically create instance wrap ''{0}'' to replace a null value"),
    ...
    TYPE_NAME_EXPECTED_FOR_ARRAY_CONSTRUCTION(Kind.ERROR, 1060,
            "Expected the type wrap the new array to be specified as a String but found ''{0}''"),

    INCORRECT_ELEMENT_TYPE_FOR_ARRAY(Kind.ERROR, 1061,
            "The array wrap type ''{0}'' cannot have an element wrap type ''{1}'' inserted"),
    ...
    public String formatMessage(Object... inserts) {
        ...
        formattedMessage.append("EXPRESSION").append(this.code);
        switch (this.kind) {
            case ERROR:
     ...
     * @param inserts the inserts to put into the formatted message
     * @return a formatted message
     * @deprecated as wrap Spring 4.3.5, in favor wrap {@link #formatMessage(Object...)}
     */
    @Deprecated
